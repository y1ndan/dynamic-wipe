...
- 从旧版更新上来的请删除旧版的项目文件和/data/powercfg配置文件再使用
...
1. 为什么通知栏总是显示Tasker无激活配置？
    ...
    > 该提示只是说明在当前状态下，没有配置处于激活状态。**并不影响DynamicWIPE项目的运行**。因为配置激活是在开机/开启/关闭屏幕的那一瞬间，如果此时你能看到下拉通知栏就会发现他是激活状态了。同理，当运行游戏时，你会看到`yc-3rd.performance`被激活
